        ...
        AnnotatedT: 'static + Annotated + Clone + fmt::Debug + Default + Send + Sync,
    {
        ...
        if !self.quiet {
            ...
            if let Err(errors) = errors.check() {
                ...
                errors.annotated_depictions(Some("Puccini Errors".into())).print_depiction(&DEFAULT_DEPICTION_CONTEXT);
            }
            ...
            if let Some(debug) = &self.debug {
                match debug {
                    ...
                    Debug::Namespaces => {
                        ...
                        depot.namespaces_depiction().print_depiction(&DEFAULT_DEPICTION_CONTEXT);
                    }
                    ...
                    Debug::Entities => {
                        ...
                        depot.entities_depiction().print_depiction(&DEFAULT_DEPICTION_CONTEXT);
                    }
                }
            }
        ...
        if !self.quiet {
            ...
            if let Err(resolve_errors) = errors.check() {
                ...
                resolve_errors
                    .annotated_depictions(Some("Puccini Errors".into()))
                    .eprint_depiction(&DEFAULT_DEPICTION_CONTEXT);
            }
            ...
            if let Err(floria_errors) = floria_errors.check() {
                ...
                floria_errors.to_depict("Floria Errors").eprint_depiction(&DEFAULT_DEPICTION_CONTEXT);
            }
