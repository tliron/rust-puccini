...
impl Compile {
    ...
    pub fn library<'environment, StoreT>(
        environment: &'environment Environment<StoreT>,
    ) -> Result<Library<'environment, StoreT>, FloriaError>
    where
        StoreT: Clone + Send + Store,
    {
        ...
        library.add_dispatch_plugin(
            ...
            include_bytes!("../../../target/wasm32-wasip2/debug/puccini_plugin_tosca_2_0_functions.wasm"),
        )?;
