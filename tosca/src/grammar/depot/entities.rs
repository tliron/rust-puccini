...
impl Depot {
    ...
    /// Get an [EntityRef],
    /// calling [complete](super::super::entity::Entity::complete) on it if
    /// [should_complete](super::super::entity::Entity::should_complete) is true.
    ///
    /// Note that the entity is removed from the depot while it is being completed.
    ...
    /// Get an [Entity](super::entity::Entity).
    ...
    /// Get an [Entity](super::super::entity::Entity),
    /// calling [complete](super::super::entity::Entity::complete) on it if
    /// [should_complete](super::super::entity::Entity::should_complete) is true.
    ///
    /// Note that the entity is removed from the depot while it is being completed.
        ...
        ErrorRecipientT: ErrorRecipient<ToscaError<AnnotatedT>>,
    {
        Ok(match self.get_complete_entity_ref(entity_kind, full_name, source_id, callstack, errors)? {
            Some(entity) => Some(entity.downcast_ref_or_error(full_name.to_string())?),
            None => None,
        })
    }
    ...
    /// Remove an entity and return its [EntityRef] and [SourceID] if it exists.
