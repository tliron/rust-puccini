    ...
    AnnotatedT: 'static + Annotated + Clone + Default,
{
    ...
    fn complete(
        ...
        errors_with_field_annotations!(
            errors, self, "members",
            complete_types(&mut self.members, &parent.members, depot, source_id, scope, errors)?;
        );
...
impl<'own, AnnotatedT> Type<OldCatalog<'own, AnnotatedT>, AnnotatedT> for GroupType<AnnotatedT>
where
    AnnotatedT: Annotated + Clone + Default,
{
        ...
        ErrorRecipientT: ErrorRecipient<ToscaError<AnnotatedT>>,
    {
        Ok(Self {
            ...
            members: complete_type_names_from(&self.members, context.parent_type, |entity| &entity.members),
