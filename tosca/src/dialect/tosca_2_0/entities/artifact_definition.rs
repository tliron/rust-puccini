    ...
    AnnotatedT: 'static + Annotated + Clone + Default,
{
    fn complete(
        ...
        let artifact_type =
            get_complete_entity!(ARTIFACT_TYPE, ArtifactType, self, type_name, catalog, source_id, errors);

        complete_map!(self, properties, artifact_type, catalog, source_id, errors);
