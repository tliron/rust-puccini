    ...
    AnnotatedT: 'static + Annotated + Clone + Default,
{
    fn complete(
        ...
        let interface_type =
            get_complete_entity!(INTERFACE_TYPE, InterfaceType, self, type_name, catalog, source_id, errors);

        complete_map!(self, inputs, interface_type, catalog, source_id, errors);
        complete_map!(self, inputs, parent, catalog, source_id, errors);
        complete_map!(self, operations, interface_type, catalog, source_id, errors);
        complete_map!(self, operations, parent, catalog, source_id, errors);
        complete_map!(self, notifications, interface_type, catalog, source_id, errors);
        complete_map!(self, notifications, parent, catalog, source_id, errors);
