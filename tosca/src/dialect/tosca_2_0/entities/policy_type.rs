    ...
    AnnotatedT: 'static + Annotated + Clone + Default,
{
    ...
    fn complete(
        ...
        let parent = get_complete_parent!(POLICY_TYPE, self, derived_from, catalog, source_id, callstack, errors);

        complete_map!(self, properties, parent, catalog, source_id, errors);
        complete_map!(self, triggers, parent, catalog, source_id, errors);
