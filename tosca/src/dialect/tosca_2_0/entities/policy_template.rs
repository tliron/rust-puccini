    ...
    AnnotatedT: 'static + Annotated + Clone + Default,
{
    ...
    fn complete(
        ...
        let policy_type = get_complete_entity!(POLICY_TYPE, PolicyType, self, type_name, catalog, source_id, errors);

        complete_map!(self, properties, policy_type, catalog, source_id, errors);
        complete_map!(self, triggers, policy_type, catalog, source_id, errors);
