...
mod value_assignments;
mod workflow_definition;

#[allow(unused_imports)]
pub use {
    artifact_assignment::*, artifact_definition::*, artifact_type::*, attribute_definition::*,
    capability_assignment::*, capability_definition::*, capability_type::*, data_type::*, dispatch::*, file::*,
    ...
    requirement_assignment::*, requirement_definition::*, service_template::*, trigger_definition::*,
    value_assignment::*, value_assignments::*, workflow_definition::*,
};
