    ...
    AnnotatedT: 'static + Annotated + Clone + Default,
{
    ...
    fn complete(
        ...
        let group_type = get_complete_entity!(GROUP_TYPE, GroupType, self, type_name, catalog, source_id, errors);

        complete_map!(self, properties, group_type, catalog, source_id, errors);
        complete_map!(self, attributes, group_type, catalog, source_id, errors);
