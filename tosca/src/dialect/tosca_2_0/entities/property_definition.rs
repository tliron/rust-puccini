    ...
    AnnotatedT: Annotated + Clone + Default,
{
    ...
    #[default(true)]
    #[resolve]
    #[debuggable(style(name), tag = tag::span)]
    pub required: bool,
...
//
// PropertyDefinitionsExt
//

/// Property definitions.
pub trait PropertyDefinitionsExt<AnnotatedT> {
...
impl<AnnotatedT> PropertyDefinitionsExt<AnnotatedT> for PropertyDefinitions<AnnotatedT>
where
    AnnotatedT: Annotated + Clone + Default,
{
    fn to_assignments<ErrorRecipientT>(
