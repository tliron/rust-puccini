    ...
    AnnotatedT: 'static + Annotated + Clone + Default,
{
    ...
    fn complete(
        ...
        let parent = get_complete_parent!(NODE_TYPE, self, derived_from, catalog, source_id, callstack, errors);

        complete_map!(self, properties, parent, catalog, source_id, errors);
        complete_map!(self, attributes, parent, catalog, source_id, errors);
        complete_map!(self, capabilities, parent, catalog, source_id, errors);
        complete_tagged_values!(self, requirements, parent, catalog, source_id, errors);
        complete_map!(self, interfaces, parent, catalog, source_id, errors);
        complete_map!(self, artifacts, parent, catalog, source_id, errors);
