    ...
    AnnotatedT: 'static + Annotated + Clone + Default,
{
    fn complete(
        ...
        let capability_type =
            get_complete_entity!(CAPABILITY_TYPE, CapabilityType, self, type_name, catalog, source_id, errors);

        complete_map!(self, properties, capability_type, catalog, source_id, errors);
        complete_map!(self, attributes, capability_type, catalog, source_id, errors);
