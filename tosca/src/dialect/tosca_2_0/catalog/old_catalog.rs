...
impl<'own, AnnotatedT> Depict for OldCatalog<'own, AnnotatedT>
where
    AnnotatedT: Annotated + Clone + Default,
{
        ...
        WriteT: io::Write,
    {
        ...
        if !self.artifact_types.is_empty() {
            ...
            self.artifact_types.depict(writer, item_context)?;
        }
        ...
        if !self.capability_types.is_empty() {
            ...
            item_context.theme.write_delimiter(writer, ":")?;
            self.capability_types.depict(writer, item_context)?;
        }
        ...
        if !self.data_types.is_empty() {
            ...
            item_context.theme.write_delimiter(writer, ":")?;
            self.data_types.depict(writer, item_context)?;
        }
        ...
        if !self.group_types.is_empty() {
            ...
            item_context.theme.write_delimiter(writer, ":")?;
            self.group_types.with_templates(&self.group_templates, "groups").depict(writer, item_context)?;
        }
        ...
        if !self.interface_types.is_empty() {
            ...
            item_context.theme.write_delimiter(writer, ":")?;
            self.interface_types.depict(writer, item_context)?;
        }
        ...
        if !self.node_types.is_empty() {
            ...
            item_context.theme.write_delimiter(writer, ":")?;
            self.node_types.with_templates(&self.node_templates, "node templates").depict(writer, item_context)?;
        }
        ...
        if !self.policy_types.is_empty() {
            ...
            item_context.theme.write_delimiter(writer, ":")?;
            self.policy_types.with_templates(&self.policy_templates, "policies").depict(writer, item_context)?;
        }
